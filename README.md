...
Solves the nonlinear coupled differential equations governing the system
...
Read the About the Topic section to understand the physics

Configure parameters in Simulation Controls

Click Run Simulation

Explore:

Mathematical Model & Equations to see the computations

Results & Plots for visual and numerical analysis
